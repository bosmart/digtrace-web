# Generated by Django 2.2.5 on 2021-02-24 03:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(error_messages={'unique': 'A user with that email already exists or invalid email'}, max_length=255, unique=True, validators=[django.core.validators.EmailValidator(), user.models.UnicodeUsernameValidator()], verbose_name='email address')),
