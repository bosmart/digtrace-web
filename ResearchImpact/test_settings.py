...
# ALLOWED_HOSTS = [pl_viewer_url, pl_viewer_url.lower(),os.environ.get('PLY_VIEWER_URL'),'127.0.0.1','furies:8082',
# 'localhost','10.8.210.4','furies','app1.astra.bluestar-software.co.uk','*.astra.bluestar-software.co.uk',
# 'app2.astra.bluestar-software.co.uk','http://bslwork12:8082','bslwork12:8082','10.0.75.1','localhost:4200',
# os.environ.get('PLY_VIEWER_URL')]

# ALLOWED_HOSTS = [pl_viewer_url, pl_viewer_url.lower(), os.environ.get('PLY_VIEWER_URL'),
#                  os.environ.get('PLY_VIEWER_URL').lower(), os.environ.get('PLY_VIEWER_URL_IP'),
#                  os.environ.get('CUSTOM_ALLOWED_HOST')]
...
# DB_NAME = 'live'
# DB_PASSWORD = 'DJXusGLr5g3P6K3xNLSxzKVP'
# DB_USER = 'digtrace'
# DB_HOST = 'localhost'
# DB_PORT = '5432'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'digtrace/static'),
)
...
""" =============== For Django Email Service  ===================== """
# DataFlair
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'digtrace.team@gmail.com'
EMAIL_HOST_PASSWORD = 'digtrace321#'

ANGULAR_PROJECT_ROOT_URL = os.environ.get('PLY_VIEWER_URL')
